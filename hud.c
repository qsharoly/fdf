...
/*   Updated: 2022/04/28 21:59:49 by debby            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	a = geom_to_pixel(a, view.cam, view.bmp.x_dim, view.bmp.y_dim);
	b = geom_to_pixel(b, view.cam, view.bmp.x_dim, view.bmp.y_dim);
